...
def _expected_report_count() -> int:
    try:
        return max(1, int(os.getenv("OMEHR_EXPECTED_REPORT_COUNT", "34")))
    except ValueError:
        return 34
...
def _snapshot_complete_reports() -> None:
    ...
    set output_last_complete/ altında tutulur. Yalnız 34/34 (veya ayarlanan
...
def _ensure_startup_reports() -> bool:
    ...
    retry yapılır. Varsayılan hedef 34 rapordur; OMEHR_EXPECTED_REPORT_COUNT ile
