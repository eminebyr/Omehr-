...
rem =====================================================================
rem BASDAS_Puantaj_Hatirlatma (her gun 09:00) ve BASDAS_Gunluk_Rapor
...
rem   schtasks /delete /tn "BASDAS_Puantaj_Hatirlatma" /f
rem   schtasks /delete /tn "BASDAS_Gunluk_Rapor" /f
rem =====================================================================
...
echo Gorev 1/2: BASDAS_Puantaj_Hatirlatma (her gun 09:00)...
schtasks /create /tn "BASDAS_Puantaj_Hatirlatma" ^
...
echo Gorev 2/2: BASDAS_Gunluk_Rapor (her gun 12:00)...
schtasks /create /tn "BASDAS_Gunluk_Rapor" ^
...
echo   schtasks /delete /tn "BASDAS_Puantaj_Hatirlatma" /f
echo   schtasks /delete /tn "BASDAS_Gunluk_Rapor" /f
pause
exit /b 0
