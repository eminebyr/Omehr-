# Personel Açıklama Alanı

- Açıklama yalnız `Fact_Mevcut` sayfasındaki **H sütununa** girilir.
- `Fact_Norm` içinde açıklama alanı bulunmaz.
- H sütunu `Norm fazlası Norm eksiği` ile `İsim Soyisim` sütunlarının arasındadır.
- `10.08.2026 tarihine kadar raporlu` yazılırsa kişi PDF ve Excel'de sarı vurgulanır; mevcut durum açıklamasına `Ad Soyad 10.08.2026 tarihine kadar raporludur.` yazılır.
